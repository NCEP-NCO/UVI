...
# modules indicated by OBJS and produce an executable named uv_index_grid_3.
#
...
SRCS=	uv_index_grid_3.f uv_erythemal.f uv_sundis.f grib.f flip_field.f

OBJS=	uv_index_grid_3.o uv_erythemal.o uv_sundis.o grib.o flip_field.o
...
# actual rules which make uses to build uv_index_grid_3.
#
all:		$(CMD)
