...
# modules indicated by OBJS and produce an executable named uv_uv24hr.
#
...
SRCS=	uv_uv24hr.f grib.f flip_field.f

OBJS=	uv_uv24hr.o grib.o flip_field.o
...
# actual rules which make uses to build uv_uv24hr.
#
all:		$(CMD)
